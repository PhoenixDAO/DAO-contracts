...
contract DaoSmartContract is MulitpleOwners, PausableUpgradeSafe {
    ...
    function withdrawCollateral(string memory proposalId, uint8 v , bytes32 r , bytes32 s ) external {
        address sender = msg.sender;
    ...
    function updateProposalStatus(string memory proposalId, uint256 status)
        external
        onlyOwners
    {
        require(
